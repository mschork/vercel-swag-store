...
- **Derive a count from a hash of the product id.** Stable and free, and rejected: The brief asks for stock "fetched from the provided API", and a hash is not fetched from anything.
