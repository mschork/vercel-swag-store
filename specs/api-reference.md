...
- Exactly 6 products are `featured: true`, which is the required minimum. Render whatever `?featured=true` returns and top up from the general list if fewer than 6 come back.
