...
- `CartSummary`: subtotal via `formatPrice`, item count, a disabled "Checkout" button with "Checkout is not part of this demo" helper text [assumption: better than no button; the brief does not require checkout].
