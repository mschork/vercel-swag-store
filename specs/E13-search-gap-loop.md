...
Branch: `epic/E13-search-gaps`. Depends on: E07, E08, E09. Blocks: E14. Ship only after E12 is otherwise ready; it must never delay the release. The epic is cut into six slices; each leaves `main` shippable, and the epic can stop after any of them.
